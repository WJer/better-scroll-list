(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["better-scroll-list"] = factory();
	else
		root["better-scroll-list"] = factory();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var EVENT_PULLING_DOWN = exports.EVENT_PULLING_DOWN = 'pulling-down';
  var EVENT_PULLING_UP = exports.EVENT_PULLING_UP = 'pulling-up';
  var EVENT_BEFORE_SCROLL_START = exports.EVENT_BEFORE_SCROLL_START = 'before-scroll-start';
  var EVENT_SCROLL = exports.EVENT_SCROLL = 'scroll';
  var EVENT_SCROLL_START = exports.EVENT_SCROLL_START = 'scroll-start';
  var EVENT_SCROLL_END = exports.EVENT_SCROLL_END = 'scroll-end';
  var EVENT_TOUCH_END = exports.EVENT_TOUCH_END = 'touch-end';
  var EVENT_FLICK = exports.EVENT_FLICK = 'flick';
  var EVENT_REFRESH = exports.EVENT_REFRESH = 'refresh';
  var EVENT_DESTROY = exports.EVENT_DESTROY = 'destroy';

  var DIRECTION_H = exports.DIRECTION_H = 'horizontal';
  var DIRECTION_V = exports.DIRECTION_V = 'vertical';
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    ...
    factory(module, exports, require('./scroll'));
  } else {
    var mod = {
      exports: {}
    };
  ...
  if (typeof window !== 'undefined' && window.Vue) {
    window.Vue.use(_scroll2.default);
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9ee8d2ce_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_scroll_vue__ = __webpack_require__(101);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9ee8d2ce_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_scroll_vue__["a" /* default */],
...
var update = __webpack_require__(16)("6d6f5d5f", content, true);
...
// module
exports.push([module.i, ".vue-scroll{display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;flex-direction:column;height:100%}", ""]);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(48), __webpack_require__(41)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('./scroll-list'), require('./common/js/config'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.scrollList, global.config);
    global.scroll = mod.exports;
  }
})(this, function (module, exports, _scrollList, _config) {
  'use strict';
  ...
  exports.default = {
    ...
    computed: {
      ...
      scrollbarObj: function scrollbarObj() {
        return this.scrollbar ? { fade: this.scrollbarFade } : false;
      },
      pullDownRefreshObj: function pullDownRefreshObj() {
    ...
    methods: {
      onScroll: function onScroll(pos) {
        this.$emit(_config.EVENT_SCROLL, pos);
      },
      onBeforeScrollStart: function onBeforeScrollStart() {
        this.$emit(_config.EVENT_BEFORE_SCROLL_START);
      },
      onScrollStart: function onScrollStart(pos) {
        this.$emit(_config.EVENT_SCROLL_START, pos);
      },
      onScrollEnd: function onScrollEnd(pos) {
        this.$emit(_config.EVENT_SCROLL_END, pos);
      },
      onTouchEnd: function onTouchEnd(pos) {
        this.$emit(_config.EVENT_TOUCH_END, pos);
      },
      onFlick: function onFlick() {
        this.$emit(_config.EVENT_FLICK);
      },
      onRefresh: function onRefresh() {
        this.$emit(_config.EVENT_REFRESH);
      },
      onDestroy: function onDestroy() {
        this.$emit(_config.EVENT_DESTROY);
      },
      onPullingDown: function onPullingDown() {
        this.$emit(_config.EVENT_PULLING_DOWN);
      },
      onPullingUp: function onPullingUp() {
        this.$emit(_config.EVENT_PULLING_UP);
      },
      ...
      errorUpdate: function errorUpdate() {
        this.$refs.scroll && this.$refs.scroll.errorUpdate();
      }
    },
    components: {
      ScrollList: _scrollList2.default
    }
  };
  module.exports = exports['default'];
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_scroll_list_vue__ = __webpack_require__(51);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_57fb30ac_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_scroll_list_vue__ = __webpack_require__(100);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_57fb30ac_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_scroll_list_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(16)("a81ca1d0", content, true);
...
// module
exports.push([module.i, ".scroll-list-wrapper{position:relative;-webkit-box-flex:1;-webkit-flex:1;flex:1;overflow:hidden;width:100%;background-color:#fff}.scroll-list-wrapper .scroll-content{position:relative;z-index:1;background-color:#fff}.scroll-list-wrapper .pulldown-wrapper{position:absolute;width:100%;left:0;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;justify-content:center;-webkit-box-align:center;-webkit-align-items:center;align-items:center;-webkit-transition:all;transition:all}.scroll-list-wrapper .pulldown-wrapper .after-trigger{margin-top:5px}.scroll-list-wrapper .pullup-wrapper{width:100%;display:-webkit-box;display:-webkit-flex;display:flex;-webkit-box-pack:center;-webkit-justify-content:center;justify-content:center;-webkit-box-align:center;-webkit-align-items:center;align-items:center;padding:16px 0}", ""]);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, exports, __webpack_require__(52), __webpack_require__(84), __webpack_require__(97), __webpack_require__(90), __webpack_require__(95), __webpack_require__(96), __webpack_require__(41)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('babel-runtime/core-js/promise'), require('babel-runtime/core-js/object/assign'), require('./components/bubble/bubble'), require('./components/loading/loading'), require('better-scroll'), require('./common/js/utils'), require('./common/js/config'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.promise, global.assign, global.bubble, global.loading, global.betterScroll, global.utils, global.config);
    global.scrollList = mod.exports;
  }
})(this, function (module, exports, _promise, _assign, _bubble, _loading, _betterScroll, _utils, _config) {
  'use strict';
  ...
  var COMPONENT_NAME = 'scroll-list';

  var DEFAULT_LOAD_TXT_MORE = '加载更多';
  var DEFAULT_LOAD_TXT_NO_MORE = '没有更多了';
  var DEFAULT_REFRESH_TXT = '刷新成功';
  var DEFAULT_REFRESH_FAIL_TXT = '刷新失败';
  ...
  exports.default = {
    ...
    computed: {
      ...
      pullUpTxt: function pullUpTxt() {
        ...
        var moreTxt = txt && txt.more || DEFAULT_LOAD_TXT_MORE;
        var noMoreTxt = txt && txt.noMore || DEFAULT_LOAD_TXT_NO_MORE;
    ...
    methods: {
      initScroll: function initScroll() {
        ...
        var options = (0, _assign2.default)({}, DEFAULT_OPTIONS, {
          scrollY: this.options.direction === _config.DIRECTION_V,
          scrollX: this.options.direction === _config.DIRECTION_H
        }, this.options);
        ...
        if (this.options.listenBeforeScroll) {
          this.scroll.on('beforeScrollStart', function () {
            _this.$emit(_config.EVENT_BEFORE_SCROLL_START);
          });
        }
        if (this.options.listenScrollStart) {
          this.scroll.on('scrollStart', function (pos) {
            _this.$emit(_config.EVENT_SCROLL_START, pos);
          });
        }
        if (this.options.listenScroll && !this.pullDownRefresh && this.options.probeType !== 0) {
          this.scroll.on('scroll', function (pos) {
            _this.$emit(_config.EVENT_SCROLL, pos);
          });
        }
        if (this.options.listenScrollEnd) {
          this.scroll.on('scrollEnd', function (pos) {
            _this.$emit(_config.EVENT_SCROLL_END, pos);
          });
        }
        if (this.options.listenTouchEnd) {
          this.scroll.on('touchEnd', function (pos) {
            _this.$emit(_config.EVENT_TOUCH_END, pos);
          });
        }
        if (this.options.listenFlick) {
          this.scroll.on('flick', function () {
            _this.$emit(_config.EVENT_FLICK);
          });
        }
        if (this.options.listenRefresh) {
          this.scroll.on('refresh', function () {
            _this.$emit(_config.EVENT_REFRESH);
          });
        }
        if (this.options.listenDestroy) {
          this.scroll.on('refresh', function () {
            _this.$emit(_config.EVENT_DESTROY);
          });
        }
        if (this.pullDownRefresh && this.options.direction !== _config.DIRECTION_H) {
          this._initPullDownRefresh();
        }
        if (this.pullUpLoad && this.options.direction !== _config.DIRECTION_H) {
      ...
      setScrollViewMinHeight: function setScrollViewMinHeight() {
        if (this.$refs.scrollWrapper && (this.pullDownRefresh || this.pullUpLoad || this.options.initMinHeight)) {
          var wrapperHeight = (0, _utils.getRect)(this.$refs.wrapper).height;
          var contentHeight = (0, _utils.getRect)(this.$refs.scrollWrapper).height - 1;
      ...
      _initPullDownRefresh: function _initPullDownRefresh() {
        ...
        this.scroll.on('scroll', function (pos) {
          if (_this4.options.listenScroll && _this4.options.probeType !== 0) {
            _this4.$emit(_config.EVENT_SCROLL, pos);
          }
        ...
        this.scroll.on('pullingDown', function () {
          _this4.$emit(_config.EVENT_PULLING_DOWN);
      ...
      _afterPullDown: function _afterPullDown() {
        ...
        setTimeout(function () {
          _this6.pullDownStyle = 'top:' + _this6.pullDownInitTop + 'px';
          _this6.beforePullDown = true;
          _this6.isRebounding = false;
          _this6.isErrorPullingDown = false;
          _this6.refresh();
      ...
      _initPullUpLoad: function _initPullUpLoad() {
        ...
        this.scroll.on('pullingUp', function () {
          _this7.$emit(_config.EVENT_PULLING_UP);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_be38d3a4_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_vue__ = __webpack_require__(94);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_be38d3a4_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_loading_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(16)("e11341b2", content, true);
...
// module
exports.push([module.i, ".loading{font-size:0}.loading-spinners{position:relative;display:inline-block;width:20px;height:20px}.loading-spinner{position:absolute;left:44.5%;top:37%;width:10%;height:25%;border-radius:50%/20%;opacity:.25;background-color:currentColor;-webkit-animation:spinner-fade 1s linear infinite;animation:spinner-fade 1s linear infinite}.loading-spinner:first-child{-webkit-animation-delay:0s;animation-delay:0s;-webkit-transform:rotate(-150deg) translateY(-150%);transform:rotate(-150deg) translateY(-150%)}.loading-spinner:nth-child(2){-webkit-animation-delay:.083333333333333s;animation-delay:.083333333333333s;-webkit-transform:rotate(-120deg) translateY(-150%);transform:rotate(-120deg) translateY(-150%)}.loading-spinner:nth-child(3){-webkit-animation-delay:.166666666666667s;animation-delay:.166666666666667s;-webkit-transform:rotate(-90deg) translateY(-150%);transform:rotate(-90deg) translateY(-150%)}.loading-spinner:nth-child(4){-webkit-animation-delay:.25s;animation-delay:.25s;-webkit-transform:rotate(-60deg) translateY(-150%);transform:rotate(-60deg) translateY(-150%)}.loading-spinner:nth-child(5){-webkit-animation-delay:.333333333333333s;animation-delay:.333333333333333s;-webkit-transform:rotate(-30deg) translateY(-150%);transform:rotate(-30deg) translateY(-150%)}.loading-spinner:nth-child(6){-webkit-animation-delay:.416666666666667s;animation-delay:.416666666666667s;-webkit-transform:rotate(0deg) translateY(-150%);transform:rotate(0deg) translateY(-150%)}.loading-spinner:nth-child(7){-webkit-animation-delay:.5s;animation-delay:.5s;-webkit-transform:rotate(30deg) translateY(-150%);transform:rotate(30deg) translateY(-150%)}.loading-spinner:nth-child(8){-webkit-animation-delay:.583333333333333s;animation-delay:.583333333333333s;-webkit-transform:rotate(60deg) translateY(-150%);transform:rotate(60deg) translateY(-150%)}.loading-spinner:nth-child(9){-webkit-animation-delay:.666666666666667s;animation-delay:.666666666666667s;-webkit-transform:rotate(90deg) translateY(-150%);transform:rotate(90deg) translateY(-150%)}.loading-spinner:nth-child(10){-webkit-animation-delay:.75s;animation-delay:.75s;-webkit-transform:rotate(120deg) translateY(-150%);transform:rotate(120deg) translateY(-150%)}.loading-spinner:nth-child(11){-webkit-animation-delay:.833333333333333s;animation-delay:.833333333333333s;-webkit-transform:rotate(150deg) translateY(-150%);transform:rotate(150deg) translateY(-150%)}.loading-spinner:nth-child(12){-webkit-animation-delay:.916666666666667s;animation-delay:.916666666666667s;-webkit-transform:rotate(180deg) translateY(-150%);transform:rotate(180deg) translateY(-150%)}@-webkit-keyframes spinner-fade{0%{opacity:.85}50%{opacity:.25}to{opacity:.25}}@keyframes spinner-fade{0%{opacity:.85}50%{opacity:.25}to{opacity:.25}}", ""]);
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"loading"},[_c('span',{staticClass:"loading-spinners",style:(_vm.style)},_vm._l((_vm.balde),function(item){return _c('i',{staticClass:"loading-spinner"})}))])}
var staticRenderFns = []
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bubble_vue__ = __webpack_require__(98);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_67e25370_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bubble_vue__ = __webpack_require__(99);
var normalizeComponent = __webpack_require__(9)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_67e25370_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bubble_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vue-scroll"},[_vm._t("top"),_vm._v(" "),_c('scroll-list',{ref:"scroll",attrs:{"data":_vm.data,"options":_vm.scrollOptions},on:{"pulling-down":_vm.onPullingDown,"before-scroll-start":_vm.onBeforeScrollStart,"pulling-up":_vm.onPullingUp,"scroll":_vm.onScroll,"scroll-start":_vm.onScrollStart,"scroll-end":_vm.onScrollEnd,"touch-end":_vm.onTouchEnd,"flick":_vm.onFlick,"refresh":_vm.onRefresh,"destroy":_vm.onDestroy}},[_vm._t("pulldown"),_vm._v(" "),_vm._t("default"),_vm._v(" "),_vm._t("pullup")],2),_vm._v(" "),_vm._t("bottom")],2)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
